...
#######################################
### A short background on text classification
# the number of times a term occurs in a document is called its term frequency.
# The weight of a term that occurs in a document is simply proportional to the term frequency.
# inverse document frequency (IDF) factor is incorporated which diminishes the weight of terms that occur very frequently in the document set and increases the weight of terms that occur rarely
...
# In scikit, the function TfidfVectorizer() converts a collection of raw documents to a matrix of TF-IDF features.
...
# See this for how OptionParser works: https://docs.python.org/2/library/optparse.html
op = OptionParser()
...
# Following code from AK. Simulating the user options given at the command line.
print_report = True
select_chi2 = 2
print_cm = True
print_top10 = True
